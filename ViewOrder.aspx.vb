...
Partial Class BVModules_ViewOrder
    ...
    Protected Sub PageLoad(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.ucManualBreadCrumbTrail.ClearTrail()
        Me.ucManualBreadCrumbTrail.AddLink(Content.SiteTerms.GetTerm("Home"), WebAppSettings.SiteStandardRoot)
        Me.ucManualBreadCrumbTrail.AddLink(Content.SiteTerms.GetTerm("CustomerService"), "~/ContactUs.aspx")
        Me.ucManualBreadCrumbTrail.AddNonLink("Order Status")
