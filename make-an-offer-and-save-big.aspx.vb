...
Partial Class SalesForceFormLead
        ...
        If Not IsPostBack Then
            ...
            If Not Request.QueryString("id") Is Nothing Then
                ...
                If _LocalProduct.MetaTitle.Trim.Length > 0 Then
                    Me.PageTitle = "Make An Offer And Save Big" & " - " & _LocalProduct.MetaTitle
                Else
                    Me.PageTitle = "Make An Offer And Save Big" & " - " & _LocalProduct.ProductName
                End If
    ...
    Protected Sub btnContact_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnContact.Click
        ...
        Dim campaignId As String = "701o0000000Dutd"
        Dim memberstatus As String = "Responded"
        ...
        'Dim cookDict As HttpCookie = New HttpCookie("userdetails")
