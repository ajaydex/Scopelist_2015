...
Public Class AddToCartClickedEventArgsMobile
    Private _variantsDisplay As IVariantDisplay
    Private _kitDisplay As IKitDisplay
    Private _messageBox As IMessageBox
    Private _page As BaseStoreProductPageMobile
    ...
    Public Property KitDisplay() As IKitDisplay
        Get
            Return _kitDisplay
        End Get
        Set(ByVal value As IKitDisplay)
            _kitDisplay = value
        End Set
    End Property
    ...
    Public Property Page() As BaseStoreProductPageMobile
        Get
            Return _page
        End Get
        Set(ByVal value As BaseStoreProductPageMobile)
            _page = value
        End Set
    End Property
