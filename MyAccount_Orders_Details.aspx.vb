...
Partial Class MyAccount_Orders_Details
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs) Handles MyBase.Load
        ...
        ManualBreadCrumbTrial.AddNonLink(Content.SiteTerms.GetTerm("OrderDetails"))

        If Not Page.IsPostBack Then
            'Me.BackButton.ImageUrl = PersonalizationServices.GetThemedButton("Previous")
            Me.BackButton.ImageUrl = Page.ResolveUrl("~/BVModules/Themes/Scopelist/ScopelistImages/button-previous.png")
