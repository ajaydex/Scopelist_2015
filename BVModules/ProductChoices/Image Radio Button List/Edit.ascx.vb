...
Partial Class BVModules_ProductChoices_DropDownList_ProductChoiceEdit
    ...
    Protected Sub ChoiceOptionSaveButton_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ChoiceOptionContinueButton.Click
        ...
        Dim choiceOptionSettingsManager As New Datalayer.ComponentSettingsManager(choiceOption.Bvin)
        choiceOption.DisplayText = ChoiceOptionNameTextBox.Text
        choiceOptionSettingsManager.SaveSetting("ImageUrl", ImageField.Text.Trim(), "bvsoftware", "Choice", "Image Radio Button")
    ...
    Protected Sub InitializeChoiceOptionForm(ByVal choiceOption As Catalog.ProductChoiceOption)
        Dim choiceOptionSettingsManager As New Datalayer.ComponentSettingsManager(choiceOption.Bvin)
        ChoiceOptionNameTextBox.Text = choiceOption.DisplayText
        ImageField.Text = choiceOptionSettingsManager.GetSetting("ImageUrl")
