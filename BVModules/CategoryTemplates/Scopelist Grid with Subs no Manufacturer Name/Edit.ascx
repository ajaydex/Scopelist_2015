<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Edit.ascx.vb" Inherits="BVModules_CategoryTemplates_Scopelist_Grid_with_Subs_no_Manufacturer_Name_Edit" %>
<table>
    <tr>
        <td class="formlabel">
            Items Per Page
