...
Partial Class BVModules_CategoryTemplates_Scopelist_Grid_with_Subs_Category
    ...
    Protected Sub PageLoad(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If LocalCategory IsNot Nothing Then
            ...
            productSearchCriteria.ManufacturerId = "18d1a219-c242-4b53-b988-4daa480a4a83"
    ...
    Public Sub PopulateCategoryInfo()
        ...
        Else
            ...
            'Me.lblTitle2.Text = "<b>" & LocalCategory.Name & "</b>"

            startH2.Visible = True
            endH2.Visible = True
            Me.lblTitle3.Visible = True
            Me.lblTitle3.Text = "<b>Best Selling " & LocalCategory.Name & "</b>"
        End If
