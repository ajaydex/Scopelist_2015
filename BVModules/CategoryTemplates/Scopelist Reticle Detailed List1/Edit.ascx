<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Edit.ascx.vb" Inherits="BVModules_CategoryTemplates_Scopelist_Reticle_Detailed_List1_Edit" %>
<table>
    <tr>
        <td class="formlabel">
            Items Per Page
        ...
        <td class="formfield">
            ...
            <bvc5:BVRegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                ControlToValidate="ItemsPerPageTextBox" ErrorMessage="Items Per Page Must Be a Numeric Value between 1 and 99"
                ValidationExpression="\d{1,2}" ForeColor=" " CssClass="errormessage">*</bvc5:BVRegularExpressionValidator>
        </td>
        <td class="formlabel">
            Pagers
        </td>
