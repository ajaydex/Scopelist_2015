<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Edit.ascx.vb" Inherits="BVModules_CategoryTemplates_Scopelist_Grid_with_Logos_Edit" %>
<table>
    <tr>
