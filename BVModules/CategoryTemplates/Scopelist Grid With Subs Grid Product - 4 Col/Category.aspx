<%@ Page Title="Category" Language="VB" MasterPageFile="~/BVModules/Themes/Bvc5/Default.master"
    AutoEventWireup="false" CodeFile="Category.aspx.vb" Inherits="BVModules_CategoryTemplates_Scopelist_Grid_With_Subs_Grid_Product___4_Col_Category" %>
    ...
    <div id="categorygridtemplate" runat="server">
        ...
        <ul class="three-column category_list">
            <asp:DataList ID="DataList1" runat="server" RepeatColumns="4" RepeatDirection="Horizontal"
                ...
                <ItemTemplate>
                    <li style="width: 205px;"><a id="recordimageanchor" runat="server" href=""></a>
