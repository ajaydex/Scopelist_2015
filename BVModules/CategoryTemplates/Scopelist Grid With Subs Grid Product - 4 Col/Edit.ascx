<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Edit.ascx.vb" Inherits="BVModules_CategoryTemplates_Scopelist_Grid_With_Subs_Grid_Product___4_Col_Edit" %>
<table>
    <tr>
        <td class="formlabel">
            Items Per Page
