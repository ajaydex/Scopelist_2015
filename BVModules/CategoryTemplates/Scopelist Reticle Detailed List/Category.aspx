<%@ Page Title="Category" Language="VB" MasterPageFile="~/BVModules/Themes/Bvc5/Default.master"
    AutoEventWireup="false" CodeFile="Category.aspx.vb" Inherits="BVModules_CategoryTemplates_Scopelist_Reticle_Detailed_List_Category" %>
            ...
            <div class="list-view">
                ...
                <div class="price-button-block">
                    <span class="float-l">Your Price: <span class="price">
                        ...
                        <asp:ImageButton ID="DetailsImageButton" runat="server" Visible="false" ImageUrl="~/BVModules/Themes/Scopelist/NewImages/button-view-detail.png"
