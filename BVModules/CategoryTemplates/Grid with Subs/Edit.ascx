<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Edit.ascx.vb" Inherits="BVModules_CategoryTemplates_Grid_with_Subs_Edit" %>
<table>
    <tr>
        ...
        <td class="formfield"><asp:TextBox ID="ItemsPerPageTextBox" runat="server"></asp:TextBox>
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="ItemsPerPageTextBox"
                ErrorMessage="Items Per Page Must Be a Numeric Value between 1 and 99" ValidationExpression="\d{1,2}" ForeColor=" " CssClass="errormessage">*</asp:RegularExpressionValidator></td>
        <td class="formfield">
