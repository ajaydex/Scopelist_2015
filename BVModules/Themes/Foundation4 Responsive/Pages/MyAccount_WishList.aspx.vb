...
Partial Class BVModules_Themes_Foundation4_Responsive_Pages_MyAccount_WishList
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If Not DeleteButton Is Nothing Then
                DeleteButton.ImageUrl = PersonalizationServices.GetThemedButton("x")
            End If
                            ...
                            For Each modifier As Orders.LineItemModifier In localWishList.Modifiers
                                If modifier.DisplayToCustomer Then
                                    ...
                                    If pmo IsNot Nothing AndAlso Not pmo.IsNull Then
                                        sb.Append("<div class=""inputvalue"">")
                                        sb.Append("<span class=""inputmodifiername"">")
                                        sb.Append(modifier.ModifierName)
                                        sb.Append("</span>")
                                        sb.Append("<span class=""inputmodifiervalue"">")
