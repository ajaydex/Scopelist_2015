<%@ Control Language="VB" AutoEventWireup="false" CodeFile="adminview.ascx.vb" Inherits="BVModules_Themes_Foundation4_Responsive_ContentBlocks_Product_Rotator_adminview" %>

<div class="block productrotator">
	<h6>Product Rotator</h6>
