...
Partial Class BVModules_Themes_Foundation4_Responsive_ContentBlocks_Category_Grid_editor
    ...
    Protected Sub btnOK_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnOk.Click
        ...
        SettingsManager.SaveSetting("Columns", Me.ddlColumns.SelectedValue, "Develisys", "Content Block", "Category Grid")
