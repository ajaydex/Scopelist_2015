...
Partial Class BVModules_Themes_Foundation4_Responsive_ContentBlocks_Product_Grid_editor
    ...
    Private Sub SaveData()
        SettingsManager.SaveSetting("Title", Me.txtTitle.Text, "Develisys", "Content Block", "Product Grid")
        SettingsManager.SaveSetting("HeadingTag", Me.ddlHeadingTag.SelectedValue, "Develisys", "Content Block", "Product Grid")
        SettingsManager.SaveSetting("Columns", Me.ddlColumns.SelectedValue, "bvsoftware", "Content Block", "Product Grid")
        SettingsManager.SaveSetting("PreContentHtml_HtmlData", Me.ucPreContentHtml.Text.Trim(), "Develisys", "Content Block", "Product Grid")
        SettingsManager.SaveSetting("PreContentHtml_PreTransformHtmlData", Me.ucPreContentHtml.PreTransformText.Trim(), "Develisys", "Content Block", "Product Grid")
        SettingsManager.SaveSetting("PostContentHtml_HtmlData", Me.ucPostContentHtml.Text.Trim(), "Develisys", "Content Block", "Product Grid")
        SettingsManager.SaveSetting("PostContentHtml_PreTransformHtmlData", Me.ucPostContentHtml.PreTransformText.Trim(), "Develisys", "Content Block", "Product Grid")

        ' Product display data
        SettingsManager.SaveSetting("CssClassPrefix", Me.txtCssClassPrefix.Text, "Develisys", "Content Block", "Product Grid")
        SettingsManager.SaveBooleanSetting("DisplayName", Me.chkDisplayName.Checked, "Develisys", "Content Block", "Product Grid")
        SettingsManager.SaveBooleanSetting("DisplayImage", Me.chkDisplayImage.Checked, "Develisys", "Content Block", "Product Grid")
        SettingsManager.SaveBooleanSetting("DisplayNewBadge", Me.chkDisplayNewBadge.Checked, "Develisys", "Content Block", "Product Grid")
        SettingsManager.SaveBooleanSetting("DisplayDescription", Me.chkDisplayDescription.Checked, "Develisys", "Content Block", "Product Grid")
        SettingsManager.SaveBooleanSetting("DisplayPrice", Me.chkDisplayPrice.Checked, "Develisys", "Content Block", "Product Grid")
        SettingsManager.SaveBooleanSetting("DisplayAddToCartButton", Me.chkDisplayAddToCartButton.Checked, "Develisys", "Content Block", "Product Grid")
        SettingsManager.SaveBooleanSetting("DisplaySelectedCheckBox", Me.chkDisplaySelectedCheckbox.Checked, "Develisys", "Content Block", "Product Grid")
        SettingsManager.SaveBooleanSetting("DisplayQuantity", Me.chkDisplayQuantity.Checked, "Develisys", "Content Block", "Product Grid")
        SettingsManager.SaveBooleanSetting("RemainOnPageAfterAddToCart", Me.chkRemainOnPageAfterAddToCart.Checked, "Develisys", "Content Block", "Product Grid")
    End Sub
