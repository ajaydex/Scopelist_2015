...
Partial Class BVModules_Themes_Foundation4_Responsive_CategoryTemplates_Sub_Sub_Category_Menu
    ...
    Public Sub rptrSubCategories_ItemDataBound(ByVal sender As Object, ByVal e As RepeaterItemEventArgs) Handles rptrSubCategories.ItemDataBound
        ...
        If children.Count > 0 Then
            ...
            Me._itemCount = childCategories.Count()
    ...
    Protected Sub rptrSubSubCategories_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs)
        If e.Item.ItemType = ListItemType.Item OrElse e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            ' Add class if last element
            If e.Item.ItemIndex = (Me._itemCount - 1) Then
                Dim containerDiv As HtmlGenericControl = CType(e.Item.FindControl("containerDiv"), HtmlGenericControl)
