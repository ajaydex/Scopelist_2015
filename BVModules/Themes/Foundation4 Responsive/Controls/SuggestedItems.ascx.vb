...
Partial Class BVModules_Themes_Foundation4_Responsive_Controls_SuggestedItems
    ...
    <ComponentModel.Browsable(True), DefaultValue("Others also purchased")> _
    ...
    Public Overrides Sub DataBind()
        ...
        If Me.Product IsNot Nothing Then
            Dim items As Collection(Of Catalog.Product) = PersonalizationServices.GetSuggestedItems(bvin)
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        Me.TitleLabel.Text = If(String.IsNullOrEmpty(Me.Title), Content.SiteTerms.GetTerm("SuggestedItems"), Me.Title)
    End Sub
