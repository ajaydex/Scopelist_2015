...
Partial Class BVModules_Themes_Foundation4_Responsive_Controls_UpSellDisplay
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        Me.TitleLabel.Text = If(String.IsNullOrEmpty(Me.Title), Content.SiteTerms.GetTerm("UpSellTitle"), Me.Title)
    End Sub
