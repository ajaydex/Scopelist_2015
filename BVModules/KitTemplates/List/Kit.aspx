<%@ Page Language="VB" MasterPageFile="~/BVModules/Themes/Bvc5/Product.master" AutoEventWireup="false"
    CodeFile="Kit.aspx.vb" Inherits="BVModules_KitTemplates_List_Kit"
...
<%@ Register Src="../../Controls/ProductReviewDisplay.ascx" TagName="ProductReview"
    TagPrefix="uc1" %>
<%@ Register src="KitComponentsDisplay.ascx" tagname="KitComponentsDisplay" tagprefix="uc12" %>
        ...
        <div id="actioncolumn">
            <div id="actioncolumnpadding">
                ...
                <div id="ProductOptions">                    
                    <uc12:KitComponentsDisplay ID="KitComponentsDisplay" runat="server" />                    
                </div>
                <div id="ProductTypes">
