<%@ Control Language="VB" AutoEventWireup="false" CodeFile="edit.ascx.vb" Inherits="BVModules_CreditCardGateways_BV_ECHOnline_edit" %>
<h1>BV ECHO Options</h1>
...
<tr>
    <td class="formlabel">
        Merchant PIN:</td>
    <td class="formfield" style="width: 185px">
        <asp:TextBox ID="txtMerchantPassword" runat="server" ToolTip='Merchant PIN is required.'></asp:TextBox>
