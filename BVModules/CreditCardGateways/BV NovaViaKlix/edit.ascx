<%@ Control Language="VB" AutoEventWireup="false" CodeFile="edit.ascx.vb" Inherits="BVModules_CreditCardGateways_BV_NovaViaKlix_edit" %>
<h1>BV NovaViaKlix Options</h1>
...
<tr>
    <td class="formlabel">
        Merchant Pin:</td>
    <td class="formfield" style="width: 185px">
        <asp:TextBox ID="txtMerchantPassword" runat="server" ToolTip="Merchant Pin Required."></asp:TextBox>
    ...
    <tr>
        <td class="formlabel">
            Merchant User:</td>
        <td class="formfield" style="width: 185px">
            <asp:TextBox ID="txtMerchantUser" runat="server" ToolTip="This field is sometimes optional. If given a User account in addition to ID please enter here."></asp:TextBox></td>
    </tr>
<tr>
    <td class="formlabel">
        Live URL:</td>
