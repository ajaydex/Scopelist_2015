<%@ Control Language="VB" AutoEventWireup="false" CodeFile="edit.ascx.vb" Inherits="BVModules_CreditCardGateways_BV_NetworkMerchants_edit" %>
<h1>BV Network Merchants Options</h1>
