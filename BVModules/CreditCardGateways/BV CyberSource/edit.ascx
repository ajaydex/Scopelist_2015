<%@ Control Language="VB" AutoEventWireup="false" CodeFile="edit.ascx.vb" Inherits="BVModules_CreditCardGateways_BV_CyberSource_edit" %>
<h1>BV CyberSource Options</h1>
...
<tr>
    ...
    <td class="formfield" style="width: 185px">
        <asp:TextBox ID="txtMerchantLogin" runat="server" ToolTip="Merchant ID (Store ID) is Required."></asp:TextBox>
...
<tr>
    ...
    <td class="formfield" style="width: 185px">
        <asp:TextBox ID="txtMerchantPassword" runat="server" ToolTip="Full Drive Path to your Keys Folder is Required. Ex: C:\YourFilePath\YourBVStoreRoot\BIN\Keys"></asp:TextBox>
...
<tr>
    <td class="formlabel">
        Test Mode:</td>
    <td class="formfield" style="width: 185px"><asp:CheckBox ID="chkTestMode" runat="server" /></td>
</tr>
    <tr>
    ...
    <td class="formlabel">
        Currency Code:</td>
    <td class="formfield" style="width: 185px">
        <asp:TextBox ID="CurrencyCodeField" runat="server"></asp:TextBox>        
</tr>
    <tr>
        <td class="formlabel" style="height: 25px">
        </td>
    ...
    <tr>
        <td align="left" class="formlabel" colspan="2" style="height: 25px">
            <b>Note:</b> <a href="..\..\BVModules\CreditCardGateways\BV CyberSource\README.html">Important Transaction Key Setup Information</a></td>
    </tr>
    <tr>
        <td align="center" class="formlabel" colspan="2" style="height: 25px">
        </td>
