<%@ Control Language="VB" AutoEventWireup="false" CodeFile="edit.ascx.vb" Inherits="BVModules_CreditCardGateways_BV_3DeltaSystems_edit" %>
<h1>BV 3 Delta Systms (3DSI) Options</h1>
...
<tr>
    ...
    <tr>
        <td class="formlabel">
            Merchant Credit Login:</td>
        <td class="formfield" style="width: 185px">
            <asp:TextBox ID="txtMerchantCreditLogin" runat="server" ToolTip="A seperate User ID is required for processing Credit Transactions."></asp:TextBox></td>
    </tr>
<tr>
