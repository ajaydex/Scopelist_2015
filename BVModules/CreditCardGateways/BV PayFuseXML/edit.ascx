<%@ Control Language="VB" AutoEventWireup="false" CodeFile="edit.ascx.vb" Inherits="BVModules_CreditCardGateways_BV_PayFuseXML_edit" %>
<h1>BV PayFuse XML&nbsp; (First National) Options</h1>
...
<tr>
    ...
    <tr>
        <td class="formlabel">
            Merchat Alias:</td>
        <td class="formfield" style="width: 185px">
            <asp:TextBox ID="txtMerchantAlias" runat="server" ToolTip="Merchant Alias is Required."></asp:TextBox>
            <bvc5:BVRequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtMerchantAlias"
                ErrorMessage="Merchant Alias Required">*</bvc5:BVRequiredFieldValidator></td>
    </tr>
<tr>
    <td class="formlabel">
        Merchat Password:</td>
    <td class="formfield" style="width: 185px">
        ...
        <bvc5:BVRequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtMerchantPassword"
            ErrorMessage="Merchant Password Required">*</bvc5:BVRequiredFieldValidator></td>
</tr>
<tr>
    <td class="formlabel">
        Live URL:</td>
...
<tr>
    <td class="formlabel">
        Test Mode:</td>
    <td class="formfield" style="width: 185px">
        <asp:DropDownList ID="ddlTestMode" runat="server" ToolTip="Select the Appropriate Test Type to Enable Testing of Gateway">
        </asp:DropDownList></td>
</tr>
    <tr>
