<%@ Control Language="VB" AutoEventWireup="false" CodeFile="edit.ascx.vb" Inherits="BVModules_CreditCardGateways_BV_MerchantAnywhere_edit" %>
<h1>BV Merchant Anywhere Options</h1>
...
<tr>
    ...
    <td class="formfield" style="width: 185px">
        <asp:TextBox ID="txtMerchantLogin" runat="server"></asp:TextBox>
...
<tr>
    ...
    <td class="formfield" style="width: 185px">
        <asp:TextBox ID="txtMerchantPassword" runat="server" ToolTip='This field requires the full drive path and file name of the PEM File. Ex:" C:\inetput\wwwroot\bvcommerce\myKey.pem"'></asp:TextBox>
