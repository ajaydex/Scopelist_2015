...
Partial Class BVModules_ProductModifiers_ImageRadioButtonList_ProductModifierView
    ...
    Protected Sub Display()
        ...
        For Each item As Catalog.ProductModifierOption In modifier.ModifierOptions
            ...
            li.Value = item.Bvin
            li.Text = String.Format("<img src=""{0}"" alt=""{1}"" title=""{1}""/>", Page.ResolveUrl("~/" + optionSettingsManager.GetSetting("ImageUrl")), item.DisplayText)
