...
Partial Class BVModules_ProductModifiers_ImageRadioButtonList_ProductModifierEdit
    ...
    Protected Sub ModifierOptionSaveButton_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ModifierOptionContinueButton.Click
        If Page.IsValid Then
            ...
            Dim modifierOptionSettingsManager As New Datalayer.ComponentSettingsManager(modifierOption.Bvin)
            modifierOption.DisplayText = ModifierOptionNameTextBox.Text
            ...
            modifierOptionSettingsManager.SaveSetting("ImageUrl", ImageField.Text.Trim(), "bvsoftware", "Modifier", "Image Radio Button List")
    ...
    Protected Sub InitializeModifierOptionForm(ByVal modifierOption As Catalog.ProductModifierOption)
        Dim modifierOptionSettingsManager As New Datalayer.ComponentSettingsManager(modifierOption.Bvin)
        ModifierOptionNameTextBox.Text = modifierOption.DisplayText
        ImageField.Text = modifierOptionSettingsManager.GetSetting("ImageUrl")
