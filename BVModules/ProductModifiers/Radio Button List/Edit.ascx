<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Edit.ascx.vb"
    Inherits="BVModules_ProductModifiers_DropDownList_ProductModifierEdit" EnableViewState="true" %>
        ...
        <table>
            <tr>
                ...
                <td class="formfield" style="height: 26px; width: 276px;">
                    <asp:TextBox ID="ModifierOptionDisplayNameTextBox" runat="server" Width="215px"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="formlabel">
                    Null Item?</td>
