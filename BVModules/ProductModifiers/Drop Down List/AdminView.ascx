...
<table>
    <tr>
        ...
        <td><anthem:DropDownList ID="ModifierList" runat="server"></anthem:DropDownList></td>
        <td><bvc5:BVRequiredFieldValidator ID="InputRequiredFieldValidator" runat="server" ControlToValidate="ModifierList"
