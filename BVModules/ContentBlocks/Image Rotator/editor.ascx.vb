...
Partial Class BVModules_ContentBlocks_Image_Rotator_editor
    ...
    Protected Sub btnOkay_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnOkay.Click
        SettingsManager.SaveSetting("PreHtml", Me.PreHtmlField.Text.Trim, "bvsoftware", "Content Block", "Image Rotator")
        SettingsManager.SaveSetting("PostHtml", Me.PostHtmlField.Text.Trim, "bvsoftware", "Content Block", "Image Rotator")
        SettingsManager.SaveBooleanSetting("ShowInOrder", Me.chkShowInOrder.Checked, "bvsoftware", "Content Block", "Image Rotator")
    ...
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnNew.Click
        ...
        If Me.EditBvinField.Value <> String.Empty Then
            ...
            SettingsManager.UpdateSettingListItem(c, "bvsoftware", "Content Block", "Image Rotator")
            ClearEditor()
        Else
            'Inserting
            c.Setting1 = Me.ImageUrlField.Text.Trim
            ...
            End If
            c.Setting4 = Me.AltTextField.Text.Trim
            SettingsManager.InsertSettingListItem("Images", c, "bvsoftware", "Content Block", "Image Rotator")
        End If
        LoadItems()
    End Sub
