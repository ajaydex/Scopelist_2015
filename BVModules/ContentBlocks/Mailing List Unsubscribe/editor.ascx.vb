...
Partial Class BVModules_ContentBlocks_Mailing_List_Unsubscribe_editor
    ...
    Private Sub LoadData()
        ...
        If Me.TitleField.Text = String.Empty Then
            Me.TitleField.Text = "Mailing List Unsubscribe"
        End If
    ...
    Private Sub SaveData()
        SettingsManager.SaveSetting("Title", Me.TitleField.Text.Trim, "bvsoftware", "Content Block", "Mailing List Unsubscribe")
        SettingsManager.SaveSetting("Instructions", Me.InstructionsField.Text.Trim, "bvsoftware", "Content Block", "Mailing List Unsubscribe")
        SettingsManager.SaveSetting("ErrorMessage", Me.ErrorMessageField.Text.Trim, "bvsoftware", "Content Block", "Mailing List Unsubscribe")
        SettingsManager.SaveSetting("SuccessMessage", Me.SuccessMessageField.Text.Trim, "bvsoftware", "Content Block", "Mailing List Unsubscribe")
        If Me.lstMailingLists.SelectedValue IsNot Nothing Then
            SettingsManager.SaveSetting("MailingListId", Me.lstMailingLists.SelectedValue, "bvsoftware", "Content Block", "Mailing List Unsubscribe")
        End If
    End Sub
