<%@ Control Language="VB" AutoEventWireup="false" CodeFile="view.ascx.vb" Inherits="BVModules_ContentBlocks_Mailing_List_Unsubscribe_view" %>
<div class="block mailingListUnsubscribe">
    <div class="decoratedblock">
        <h4><span><asp:Label ID="lblTitle" runat="server" Text="Mailing List Unsubscribe"></asp:Label></span></h4>
