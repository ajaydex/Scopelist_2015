...
Partial Class BVModules_ContentBlocks_Mailing_List_Signup_view
        ...
        Else
            Try
                If EmailAddressField.Text.Trim.Length > 3 Then
                    ...
                    mm.EmailAddress = EmailAddressField.Text.Trim
