...
Partial Class BVModules_ContentBlocks_Html_Rotator_view
    ...
    Private Sub LoadHtml()
        ...
        If myHtml IsNot Nothing Then
            If myHtml.Count > 0 Then
                ...
                Me.HtmlContent.Text = myHtml(displayIndex).Setting1
                Me.HtmlContent.Visible = True
            Else
                Me.HtmlContent.Visible = False
            End If
        End If
    End Sub
