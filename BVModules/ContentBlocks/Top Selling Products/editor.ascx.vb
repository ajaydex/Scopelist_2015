...
Partial Class BVModules_ContentBlocks_Top_Selling_Products_editor
    Inherits Content.BVModule

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            Me.ucProductDisplayType.DisplayMode = BVSoftware.BVC5.Core.Controls.ProductDisplayType.List
    ...
    Private Sub LoadData()
        ...
        Me.ucProductDisplayType.DisplayMode = SettingsManager.GetIntegerSetting("ProductDisplayType")
        Me.ucProductDisplayType.Columns = SettingsManager.GetIntegerSetting("Columns", 3)
    ...
    Private Sub SaveData()
        ...
        SettingsManager.SaveIntegerSetting("ProductDisplayType", CType(Me.ucProductDisplayType.DisplayMode, Integer), "Develisys", "Content Block", "Develisys Top Sellers")
        SettingsManager.SaveIntegerSetting("Columns", Me.ucProductDisplayType.Columns, "Develisys", "Content Block", "Develisys Top Sellers")
