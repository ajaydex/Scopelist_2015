...
Partial Class BVModules_Shipping_By_Item_Count_edit
    ...
    Private Sub LoadData()
        ...
        If Me.NameField.Text = String.Empty Then
            Me.NameField.Text = "By Item Count"
        End If
    ...
    Private Sub SaveData()
        SettingsManager.SaveSetting("Name", Me.NameField.Text.Trim, "bvsoftware", "Shipping Method", "By Item Count")
    ...
    Private Sub SaveLevels(ByVal levels As Utilities.SortableCollection(Of Shipping.ShippingMethodLevel))
        ...
        SettingsManager.SaveSetting("Levels", data, "bvsoftware", "Shipping Method", "By Item Count")
    End Sub
