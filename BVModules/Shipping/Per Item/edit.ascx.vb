...
Partial Class BVModules_Shipping_Per_Item_edit
    ...
    Private Sub SaveData()
        SettingsManager.SaveSetting("Name", Me.NameField.Text.Trim, "bvsoftware", "Shipping Method", "Per Item")
    ...
    Private Sub SaveLevels(ByVal levels As Utilities.SortableCollection(Of Shipping.ShippingMethodLevel))
        ...
        SettingsManager.SaveSetting("Levels", data, "bvsoftware", "Shipping Method", "Per Item")
    End Sub
