<%@ Control Language="VB" AutoEventWireup="false" CodeFile="edit.ascx.vb" Inherits="BVModules_Shipping_Per_Item_edit" %>
<h1>
    Edit Shipping Method - Per Item</h1>
        ...
        <tr>
            <td class="formfield" colspan="2">
                <asp:GridView ID="GridView1" CellPadding="3" runat="server" AutoGenerateColumns="False"
                    DataKeyNames="bvin">
                    <Columns>
                        <asp:BoundField DataField="Level" HeaderText="When Item Count is at least" />
                        <asp:BoundField DataField="Amount" DataFormatString="{0:C}" HeaderText="Charge This Amount Per Item" />
