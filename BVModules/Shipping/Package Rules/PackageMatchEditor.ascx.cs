...
public partial class BVModules_Shipping_Package_Rules_PackageMatchEditor : UserControl
{
    #region Properties
    ...
    private readonly Regex hiddenLimitPackageProperties =
        new Regex("Invisible", RegexOptions.IgnoreCase | RegexOptions.Compiled);

    private readonly Regex hiddenMatchPackageProperties =
        new Regex("FixedAmountOne|Invisible", RegexOptions.IgnoreCase | RegexOptions.Compiled);
