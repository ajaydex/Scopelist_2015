<%@ Control Language="C#" CodeFile="PackagingRules.ascx.cs" Inherits="BVModules_Shipping_Order_Rules_PackagingRules" %>
...
<div class="section">
    ...
    <p>
    	After the shipping costs are calculated, the order is divided into
        separate suggested packages: one package for each
        drop shipper, one package for each item that ships separately, 
        and one package for all of the remaining items.
        By adding Packaging Rules, you can divide the default packages
        for more accurate pick-and-pack.
    </p>
    
    <asp:ObjectDataSource ID="PackagingRulesDataSource" runat="server"
        TypeName="StructuredSolutions.Bvc5.Shipping.Providers.Packaging.OrderRulePackagingRulesDataSource"
                ...
                <ItemTemplate>
                   	<div style="padding: 20px;">
                        ...
                        <ol style="list-style: none; margin: 0; padding: 0;">
                            <li style="margin: 0; padding: 0;" value="<%# (PackagingRules.PageIndex * PackagingRules.PageSize) + ((GridViewRow)Container).RowIndex + 1%>">
                                <%# Eval("Name") %>
                            </li>
                        </ol>
                    </div>
                ...
                <EditItemTemplate>
                	<div style="padding: 20px;">
                        ...
                        <table class="formtable subform">
                            ...
                            <tr>
                                <td class="formlabel" colspan="2">Dimensions:</td>
                           	</tr>
                            <tr>
