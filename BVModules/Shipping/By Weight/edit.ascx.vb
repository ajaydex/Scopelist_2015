...
Partial Class BVModules_Shipping_By_Weight_edit
    ...
    Private Sub SaveData()
        SettingsManager.SaveSetting("Name", Me.NameField.Text.Trim, "bvsoftware", "Shipping Method", "By Weight")
    ...
    Private Sub SaveLevels(ByVal levels As Utilities.SortableCollection(Of Shipping.ShippingMethodLevel))
        ...
        SettingsManager.SaveSetting("Levels", data, "bvsoftware", "Shipping Method", "By Weight")
    End Sub
