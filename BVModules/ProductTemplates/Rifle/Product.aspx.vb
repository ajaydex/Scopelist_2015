...
Partial Class BVModules_ProductTemplates_Rifle_Product
    ...
    Private Sub PageLoad(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End If
        'AddHandler AddToWishlist1.Clicked, AddressOf AddToWishlistClicked
        CheckForBackOrder()
        ...
        End If
        'card1.Src = Page.ResolveUrl("~/BVModules/Themes/OpticAuthority/Images/buttons/card1.png")
        'card2.Src = Page.ResolveUrl("~/BVModules/Themes/OpticAuthority/Images/buttons/card2.png")
        'card3.Src = Page.ResolveUrl("~/BVModules/Themes/OpticAuthority/Images/buttons/card3.png")
        'card4.Src = Page.ResolveUrl("~/BVModules/Themes/OpticAuthority/Images/buttons/card4.png")
    End Sub
