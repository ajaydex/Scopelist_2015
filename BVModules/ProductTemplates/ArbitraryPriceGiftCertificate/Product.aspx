<%@ Page Language="VB" MasterPageFile="~/BVModules/Themes/Bvc5/Product.master" AutoEventWireup="false"
    CodeFile="Product.aspx.vb" Inherits="BVModules_ProductTemplates_ArbitraryPriceGiftCertificate_Product"
    ...
    <div id="bvc5productpage">
        ...
        <div id="actioncolumn">
            <div id="actioncolumnpadding">
                Value: <asp:TextBox ID="ValueTextBox" runat="server" Width="88px"></asp:TextBox><br />
                &nbsp;<br />
                <uc4:AddToCartButton ID="AddToCartButton1" runat="server" />
            </div>
