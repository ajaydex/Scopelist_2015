<%@ Page Title="Product Details" Language="VB" MasterPageFile="~/BVModules/Themes/Bvc5/Default.master"
    AutoEventWireup="false" CodeFile="Product.aspx.vb" Inherits="BVModules_ProductTemplates_Riflescope_Product" %>
        ...
        <div id="tab_holder" style="padding-top: 0px;">
            ...
            <div class="tab_info">
                <div class="tab" property="gr:description">
                    ...
                    <span class="ProductPropertyLabel">
                        <asp:Label ID="lblMPNTitle" runat="server" CssClass="ProductPropertyLabel"></asp:Label>
                    </span>
                    <anthem:Label ID="lblMPN" runat="server" AutoUpdateAfterCallBack="true">
                    </anthem:Label>
                    <br />
