...
Partial Class BVModules_ProductTemplates_Riflescope_Product
        ...
        If info IsNot Nothing Then
            ...
            If info.MPN <> String.Empty Then
                ...
                If productTypeId.Trim <> String.Empty Then
                    ...
                    If Not props.Where(Function(p) p.DisplayName.Contains(Content.SiteTerms.GetTerm("MPN"))).Any() And Not info.MPN Is Nothing Then
                        Me.lblMPNTitle.Text = "<br/>" & Content.SiteTerms.GetTerm("MPN")
                        Me.lblMPN.Text = info.MPN
                    End If
                End If
            End If
        End If
