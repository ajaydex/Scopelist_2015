...
Partial Class BVModules_ProductTemplates_Scopelist_Layout_Product
    ...
    Private Sub PageLoad(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If LocalProduct IsNot Nothing Then
            ...
            Dim ManufacturerName As String = GetProductManufacturer(LocalProduct)

            'Swarovski Opitcs
            Dim BrandsToExclude As String()
            BrandsToExclude = Content.SiteTerms.GetTerm("ExcludedBrandName").Split(",")

            'Brands Swarovski Optics,Docter Optics
            ...
            Else
                CType(Page, BaseStorePage).MetaKeywords = LocalProduct.ProductName & " , " & LocalProduct.Sku
            End If
        ...
        plusIcon.Src = Page.ResolveUrl("~/BVModules/Themes/Scopelist/ScopelistImages/plus-icon.jpg")
        ...
        If Not Page.IsPostBack Then
            If LocalProduct IsNot Nothing Then
                ...
                Me.lblSKUTitle.Text = "<span itemprop='hasMPN'>" & Content.SiteTerms.GetTerm("Sku") & "</span>"
                ...
                End If
                'added and commented by developer
                'Me.outofstockLogo.Src = Page.ResolveUrl("~/BVModules/Themes/OpticAuthority/Images/buttons/outofstock.png")
                'Me.outofstockDisplayPanel.Visible = True
            End If
        Else
    ...
    Public Overrides Sub PopulateProductInfo(ByVal IsValidCombination As Boolean)
        ...
        Me.lblSubName.Text = LocalProduct.ProductName
        ...
        '    Me.lSubtitle.Text = LocalProduct.
        'End If
        ...
        If Not WebAppSettings.DisableInventory Then
            Select Case Me.LocalProduct.InventoryStatus
                ...
                Case Else
                    ...
                    'Me.outofstockDisplayPanel.Visible = False
            End Select
        End If
    End Sub
