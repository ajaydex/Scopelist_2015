<%@ Page Title="Product Details" Language="VB" MasterPageFile="~/BVModules/Themes/Bvc5/Default.master"
    AutoEventWireup="false" CodeFile="Product.aspx.vb" Inherits="BVModules_ProductTemplates_Disc_Riflescope_Product" %>

<%@ Register Src="../../Controls/DiscontinuedDisplay.ascx" TagName="DiscontinuedDisplay" TagPrefix="uc15" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentHolder" runat="Server">
    ...
    <div xmlns:foaf="http://xmlns.com/foaf/0.1/" xmlns:gr="http://purl.org/goodrelations/v1#"
		...
		<div class="prod_action">
				<div style="width:955px;margin-left:0px;background-color:#dddddd;padding-left:4px;padding-bottom:8px;padding-top:8px;">
				<p style='color:#ff0000;font-size:150%;font-weight:bold'>Product Is No Longer Available</p><br />
				<p style='text-align:left;'><asp:Label id="lblDiscontinued" runat="server" style="font-weight:bold;" /> is no longer available.  Please call us at (866) 271-7212 and our knowledgeable staff will help you select an appropriate replacement!</p>
		</div>
        <h1 property="gr:name">
                ...
                <anthem:Panel ID="pnlPrices" runat="server" class="pnlPrices" rel="gr:hasPriceSpecification">
                    <span typeof="gr:UnitPriceSpecification"><span property="gr:hasCurrencyValue" id="currencyValueForListPrice"
                        runat="server"><span class="detailpage-price" runat="server" id="trListPrice">
                            ...
                            </span><span property="gr:hasCurrency" content="USD"></span></span>
        ...
        <div id="tab_holder" style="padding-top: 0px;">
            <ul class="tabs">
                <li><a href="" class="current">Product Description</a></li>
            ...
            <div class="tab_info">
                <div class="tab" property="gr:description">
                    ...
                    <br />
                    <uc13:ProductTypeDisplay ID="ProductTypeDisplay1" runat="server">
                    </uc13:ProductTypeDisplay>
