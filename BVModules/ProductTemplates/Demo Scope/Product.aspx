<%@ Page Title="Product Details" Language="VB" MasterPageFile="~/BVModules/Themes/Bvc5/Default.master"
    AutoEventWireup="false" CodeFile="Product.aspx.vb" Inherits="BVModules_ProductTemplates_Demo_Scope_Product" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentHolder" runat="Server">
    ...
    <div xmlns:foaf="http://xmlns.com/foaf/0.1/" xmlns:gr="http://purl.org/goodrelations/v1#"
		...
		<div class="prod_action">
				...
				<p style='text-align:left;'><asp:Label id="lblDiscontinued" runat="server" style="font-weight:bold;" /> is no longer available.  Please call us at (877) 741-5532 and our knowledgeable staff will help you select an appropriate replacement!</p>
		</div>
        <h1 property="gr:name">
        ...
        <div class="price-qty-button">
            <anthem:Panel ID="ProductControlsPanel" runat="server">
                <anthem:Panel ID="pnlPrices" runat="server" rel="gr:hasPriceSpecification">
                    ...
                    <div class="qty-detailpage float-r">
