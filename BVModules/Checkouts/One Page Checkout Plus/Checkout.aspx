<%@ Page Language="VB" MasterPageFile="~/BVModules/Themes/Bvc5/Default.master" AutoEventWireup="false" CodeFile="Checkout.aspx.vb" Inherits="BVModules_Checkouts_One_Page_Checkout_Plus" Title="Checkout" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentHolder" runat="Server">
    <asp:Panel DefaultButton="btnSubmit" runat="server">
        <div id="OnePageCheckoutPlus">
		    ...
		    <asp:ValidationSummary ID="ValidationSummary1" runat="server" CssClass="errormessage" forecolor=" " HeaderText="<span>Oops! It looks like not all of the required fields were completed.</span>" />
		
            <!-- SHIPPING ADDRESS -->
            <anthem:Panel ID="pnlShipping" CssClass="checkoutStep stepShippingAddress" runat="server">
                <h2 id="ShipToHeader" runat="server">Shipping Address &amp; Method</h2>
                <div class="checkoutStepColumn1">
                    ...
                    <div class="checkoutFieldColumn1">
                        ...
                        <div class="checkoutField" runat="server">
                        ...
                        <div id="ShippingCompanyNameRow" class="checkoutField" runat="server">
                        ...
                        <div id="ShippingPhoneRow" class="checkoutField" runat="server">
                        ...
                        <div id="ShippingFaxRow" class="checkoutField" runat="server">
                        ...
                        <div id="ShippingWebSiteURLRow" class="checkoutField" runat="server">
                    ...
                    <div class="checkoutFieldColumn2">
                        <div class="checkoutField">
                        ...
                        <anthem:Panel CssClass="checkoutField" AutoUpdateAfterCallBack="true" runat="server">
                            ...
                            <anthem:DropDownList runat="server" ID="ShippingCountyField" TabIndex="1113" AutoCallBack="True" />
                        </anthem:Panel>
                    </div>
            ...
            <!-- BILLING ADDRESS -->
            <anthem:Panel ID="BillToSection" CssClass="checkoutStep stepBillingAddress" AutoUpdateAfterCallback="True" runat="server">
                ...
                <anthem:Panel ID="pnlBilling" CssClass="checkoutStepColumn1" runat="server">
                    ...
                    <div class="checkoutFieldColumn1">
                        ...
                        <div id="BillingCompanyNameRow" class="checkoutField" runat="server">
                        ...
                        <div id="BillingPhoneRow" class="checkoutField" runat="server">
                        ...
                        <div id="BillingFaxRow" class="checkoutField" runat="server">
                        ...
                        <div id="BillingWebSiteURLRow" class="checkoutField" runat="server">
                    ...
                    <div class="checkoutFieldColumn2">
                        ...
                        <div class="checkoutField" visible="false" runat="server">
                            <asp:Label ID="BillingCountyLabel" AssociatedControlID="BillingCountyField" Text="County" runat="server" />
                            <anthem:DropDownList runat="server" ID="BillingCountyField" AutoCallBack="true" TabIndex="2113" />
                        </div>
                    </div>
            ...
            <anthem:Panel ID="pnlGiftCertificate" AutoUpdateAfterCallBack="true" CssClass="checkoutStep stepGiftCertificate" runat="server">
            ...
            <anthem:Panel ID="pnlPayment" AutoUpdateAfterCallBack="true" runat="server">
	            <div class="checkoutStep stepPayemntMethod">
	                ...
	                <div id="PaymentMethods" class="checkoutStepColumn1">
            ...
            <!-- PROMOTIONAL CODE -->
            <anthem:Panel ID="pnlCoupons" CssClass="checkoutStep stepPromotionCode" runat="server" AutoUpdateAfterCallBack="true" DefaultButton="btnAddCoupon">
            ...
            <!-- CREATE YOUR ACCOUNT -->
            <asp:Panel ID="pnlPassword" CssClass="checkoutStep stepCreateAccount" runat="server">
            ...
            <!-- REVIEW YOU ORDER -->
            <div class="checkoutStep stepReview">
		                        ...
		                        <asp:GridView GridLines="None" ID="ItemsGridView" cssclass="itemTable" runat="server" AutoGenerateColumns="False" Width="100%" DataKeyNames="bvin">
		                            <Columns>
		                                ...
		                                <asp:TemplateField HeaderText="Product">
		                                    <ItemTemplate>
	                                    	    <div class="pad10">
	                                                <asp:Label ID="DescriptionField" runat="server" CssClass="ProductName" /><br />
	                                                <asp:Label ID="SKUField" runat="server" />
	                                                <asp:PlaceHolder ID="CartInputModifiersPlaceHolder" runat="server" />
	                                            </div>
		                                    </ItemTemplate>
		                                    <ItemStyle CssClass="one" />
		                                    <HeaderStyle CssClass="one" />
		                                </asp:TemplateField>
            ...
            <div class="checkoutStep stepMailingList">
                <div class="checkoutStepColumn1">
                ...
                <div class="checkoutStepColumn2">
            	    <div class="checkoutInstructions">
                        <div>
                            <asp:CheckBox ID="chkMailingListSignup" Text=" Yes! I want to receive occasional email promotions." TabIndex="3102" runat="server" />
                        </div>
