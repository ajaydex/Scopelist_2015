...
Partial Class BVModules_OrderTasks_Email_Order_edit
    ...
    Private Sub SaveData()
        Me.SettingsManager.SaveSetting("StepName", Me.StepNameField.Text.Trim, "bvsoftware", "Order Tasks", "Email Order")
        Me.SettingsManager.SaveSetting("EmailTemplate", Me.EmailTemplateField.SelectedValue, "bvsoftware", "Order Tasks", "Email Order")
        Me.SettingsManager.SaveSetting("CustomEmail", Me.CustomToField.Text.Trim, "bvsoftware", "Order Tasks", "Email Order")
        Me.SettingsManager.SaveSetting("ToEmail", Me.EmailToField.SelectedValue, "bvsoftware", "Order Tasks", "Email Order")
    End Sub
