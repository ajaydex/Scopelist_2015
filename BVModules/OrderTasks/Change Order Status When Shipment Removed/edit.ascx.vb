...
Partial Class BVModules_OrderTasks_Change_Order_Status_When_Shipment_Removed_edit
    ...
    Private Sub SaveData()
        Me.SettingsManager.SaveSetting("StepName", Me.StepNameField.Text.Trim, "bvsoftware", "Order Tasks", "Change Order Status When Shipment Removed")
        Me.SettingsManager.SaveSetting("OrderStatusCode", Me.OrderStatusDropDownList.SelectedValue, "bvsoftware", "Order Tasks", "Change Order Status When Shipment Removed")
    End Sub
End Class
