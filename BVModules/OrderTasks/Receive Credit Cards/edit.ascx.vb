...
Partial Class BVModules_OrderTasks_Receive_Credit_Cards_edit
    ...
    Private Sub LoadData()
        ...
        If errorMessage = String.Empty Then
            errorMessage = "An error occurred while attempting to process your credit card. Please check your payment information and try again."
        End If
    ...
    Private Sub SaveData()
        Me.SettingsManager.SaveSetting("StepName", Me.StepNameField.Text.Trim, "bvsoftware", "Order Tasks", "Receive Credit Cards")
        Me.SettingsManager.SaveBooleanSetting("ThrowErrors", Me.chkThrowErrors.Checked, "bvsoftware", "Order Tasks", "Receive Credit Cards")
        Me.SettingsManager.SaveSetting("CustomerErrorMessage", Me.CustomerErrorMessageField.Text.Trim, "bvsoftware", "Order Tasks", "Receive Credit Cards")
        Me.SettingsManager.SaveBooleanSetting("SetStatusOnFail", Me.chkSetStatusOnFail.Checked, "bvsoftware", "Order Tasks", "Receive Credit Cards")
        Me.SettingsManager.SaveSetting("FailStatusCode", Me.FailStatusField.SelectedValue, "bvsoftware", "Order Tasks", "Receive Credit Cards")
    End Sub
