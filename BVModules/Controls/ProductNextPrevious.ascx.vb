...
Partial Class BVModules_Controls_ProductNextPrevious
                ...
                If Not String.IsNullOrEmpty(catId) Then
                    ...
                    If Not String.IsNullOrEmpty(c.Bvin) Then
                        ...
                        If products.Count > 1 Then
                            ...
                            Me.lnkNext.Text = Content.SiteTerms.GetTerm("NextProduct")
                            Me.lnkPrev.Text = Content.SiteTerms.GetTerm("PreviousProduct")
