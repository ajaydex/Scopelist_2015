...
Partial Class BVModules_Controls_DiscontinuedDisplay
                    ...
                    Select Case prod.InventoryStatus
                        Case Catalog.ProductInventoryStatus.NotAvailable
                            ...
                            ElseIf prodPage.LocalProduct.OutOfStockMode = Catalog.ProductInventoryMode.OutOfStockDisallowOrders Then
                                ...
                                'End
                                Me.OutOfStockLiteral.Text = "<p class='mail' style='width:312px;';>E-mail <a href='mailto:sales@scopelist.com' style='font-size:135%'>sales@scopelist.com</a><br />or Call <span style='font-size:120%'>(866) 271-7212</span> to find a suitable replacement</p>"
