...
Partial Class BVModules_Controls_AdminPanel
        ...
        If SessionManager.IsAdminUser = True Then
            ...
            If TypeOf Me.Page Is BaseStoreProductPage Then
                ...
                If product IsNot Nothing Then
                    ...
                    If product.SpecialProductType = Catalog.SpecialProductTypes.Normal Then
                        sb.Append("<a href=""" & Page.ResolveUrl("~/") & "BVAdmin/Catalog/Products_Edit.aspx?id=" & Request.QueryString("productID") & """ target=""" & newWindow & """ TabIndex=""3"">")
                    ...
                    ElseIf product.SpecialProductType = Catalog.SpecialProductTypes.GiftCertificate OrElse product.SpecialProductType = Catalog.SpecialProductTypes.ArbitrarilyPricedGiftCertificate Then
                        sb.Append("<a href=""" & Page.ResolveUrl("~/") & "BVAdmin/Catalog/GiftCertificateEdit.aspx?id=" & Request.QueryString("productID") & """ target=""" & newWindow & """ TabIndex=""3"">")
                        sb.Append("Edit this Gift Certificate")
                        sb.Append("</a>")
                    ElseIf product.SpecialProductType = Catalog.SpecialProductTypes.Kit Then
                        sb.Append("<a href=""" & Page.ResolveUrl("~/") & "BVAdmin/Catalog/Kit_Edit.aspx?id=" & Request.QueryString("productID") & """ target=""" & newWindow & """ TabIndex=""3"">")
            ...
            ElseIf TypeOf Me.Page Is BaseStoreCategoryPage Then
                ...
                If Not String.IsNullOrEmpty(catId) Then
                    Dim sb As New StringBuilder()
                    sb.Append("<a href=""" & Page.ResolveUrl("~/") & "BVAdmin/Catalog/Categories_Edit.aspx?id=" & catId & """ target=""" & newWindow & """ TabIndex=""3"">")
            ...
            ElseIf TypeOf Me.Page Is BaseStoreCustomPage Then
                ...
                If Not String.IsNullOrEmpty(pageId) Then
                    Dim sb As New StringBuilder()
                    sb.Append("<a href=""" & Page.ResolveUrl("~/") & "BVAdmin/Content/CustomPages_Edit.aspx?id=" & pageId & """ target=""" & newWindow & """ TabIndex=""3"">")
            ...
            If String.Compare(Request.Url.AbsolutePath, "/" + WebAppSettings.DefaultHomePage, True) = 0 Then
                Dim sb As New StringBuilder
                sb.Append("<a href=""" & Page.ResolveUrl("~/") & "BVAdmin/Content/Columns_Edit.aspx?id=1"" target=""" & newWindow & """ TabIndex=""4"">")
                sb.Append("Column 1")
                sb.Append("</a>")
                sb.Append(" - ")
                sb.Append("<a href=""" & Page.ResolveUrl("~/") & "BVAdmin/Content/Columns_Edit.aspx?id=2"" target=""" & newWindow & """ TabIndex=""5"">")
                sb.Append("Column 2")
                sb.Append("</a>")
                sb.Append(" - ")
                sb.Append("<a href=""" & Page.ResolveUrl("~/") & "BVAdmin/Content/Columns_Edit.aspx?id=3"" target=""" & newWindow & """ TabIndex=""6"">")
                sb.Append("Column 3")
                sb.Append("</a>")
                Me.editLinks.Text = sb.ToString()
                Me.editLinks.Visible = True
