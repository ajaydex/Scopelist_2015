...
Partial Class BVModules_Controls_SearchCriteria
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Me.btnSearch.ImageUrl = Page.ResolveUrl("~/BVModules/Themes/Scopelist/ScopelistImages/button-search.png")
            LoadSettings()
    ...
    'Private Sub LoadCustomProperty(ByVal bvin As String, ByVal row As System.Web.UI.HtmlControls.HtmlTableRow, ByVal propertyLabel As Label, ByVal ddl As DropDownList, ByVal tb As TextBox)
    Private Sub LoadCustomProperty(ByVal bvin As String, ByVal row As System.Web.UI.HtmlControls.HtmlControl, ByVal propertyLabel As Label, ByVal ddl As DropDownList, ByVal tb As TextBox)
