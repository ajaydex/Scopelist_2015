<%@ Page Language="VB" MasterPageFile="~/BVAdmin/BVAdminReports.master" AutoEventWireup="false" CodeFile="View.aspx.vb" Inherits="BVModules_Reports_Sales_By_Manufacturer_View" Title="Sales By Manufacturer" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="gvManufacturers" AutoGenerateColumns="False" ShowFooter="true" AllowPaging="False" AllowSorting="False" PagerSettings-Mode="Numeric" BorderColor="#CCCCCC" CellPadding="0" GridLines="None" Width="100%"  runat="server">
        <Columns>			
