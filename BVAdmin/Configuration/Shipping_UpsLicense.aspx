<%@ Page Language="VB" MasterPageFile="~/BVAdmin/BVAdmin.master" AutoEventWireup="false"
    CodeFile="Shipping_UpsLicense.aspx.vb" Inherits="BVAdmin_Configuration_Shipping_UpsLicense"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h1>
        UPS OnLine<sup>&reg;</sup> Tools License Application</h1>
    <br />
    <table border="0" cellspacing="0" cellpadding="5">
        ...
        <tr>
            ...
            <td class="formfield" align="right" valign="top">
                <asp:ImageButton ID="btnAccept" runat="server" ImageUrl="~/BVAdmin/images/buttons/IAgree.png" />
            </td>
        </tr>
        <tr>
