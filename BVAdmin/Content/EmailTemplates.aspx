<%@ Page Language="VB" MasterPageFile="~/BVAdmin/BVAdmin.master" AutoEventWireup="false"
    CodeFile="EmailTemplates.aspx.vb" Inherits="BVAdmin_Content_EmailTemplates" Title="Untitled Page" %>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            ...
            <td align="right" valign="middle">
                <asp:ImageButton ID="btnNew" runat="server" AlternateText="Add New Template" ImageUrl="~/BVAdmin/Images/Buttons/New.png" />
            </td>
        </tr>
    </table>
    &nbsp;
