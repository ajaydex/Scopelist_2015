<%@ Page Language="VB" MasterPageFile="~/BVAdmin/BVAdminPopup.master" AutoEventWireup="false" CodeFile="GettingStartedChecklist.aspx.vb" Inherits="BVAdmin_GettingStartedChecklist" title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="BvcAdminPopupConent" Runat="Server">
	...
	<div style="text-align:center">
	    <br />
	    <a onClick="JavaScript:window.close();" href="#"><img src="Images/Buttons/Continue.png" border="0" alt="Close Window"></a>
	    <br />
	</div>
</asp:Content>
