...
Partial Class BVAdmin_Controls_SimpleProductFilter
    ...
    Public Function LoadProducts() As Catalog.ProductSearchCriteria
        ...
        SessionManager.AdminProductCriteriaStatus = Me.StatusFilter.SelectedValue
        SessionManager.AdminProductCriteriaInventoryStatus = Me.InventoryStatusFilter.SelectedValue
        SessionManager.AdminProductCriteriaProductType = Me.ProductTypeFilter.SelectedValue
    ...
    Private Sub PopulateFilterFields()
        ...
        SetListToValue(Me.StatusFilter, SessionManager.AdminProductCriteriaStatus)
        SetListToValue(Me.InventoryStatusFilter, SessionManager.AdminProductCriteriaInventoryStatus)
        SetListToValue(Me.ProductTypeFilter, SessionManager.AdminProductCriteriaProductType)
    End Sub
    ...
    Private Sub PopulateInventoryStatus()
        ...
        If WebAppSettings.DisableInventory Then
            ...
            Me.InventoryStatusFilter.Enabled = False
        Else
