...
Partial Class MyAccount_ChangeEmail
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs) Handles MyBase.Load
        ...
        ManualBreadCrumbTrial.AddNonLink(Content.SiteTerms.GetTerm("ChangeEmail"))
        ...
        If Page.IsValid() Then
            ...
            If UserAccount.DoPasswordsMatch(inPassword.Text, thisUser) Then
                Try
                    ...
                    msg.ShowOk("Email Address Changed")
                Catch CreateEx As BVMembershipUserException
                    Select Case CreateEx.Status
                        Case CreateUserStatus.DuplicateUsername
                            msg.ShowWarning("A user account with that email address already exists. Please select another email address.")
                        Case CreateUserStatus.InvalidPassword
                            msg.ShowWarning("Please check your password and try again.")
                        Case CreateUserStatus.UserNotFound
                            msg.ShowWarning("User account couldn't be located.")
                        Case Else
                    End Select
                End Try

            Else
                msg.ShowWarning("Couldn't update E-mail Address.  Please check your password.")
            End If
